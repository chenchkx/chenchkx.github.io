...
- <font size="1">Improving Expressivity of GNNs with Subgraph-specific Factor Embedded Normalization. [[Paper](https://arxiv.org/abs/2305.19903){:target="_blank"}] [[Code](https://github.com/chenchkx/SuperNorm){:target="_blank"}]\\
  ...
  *ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD)*, 2023.</font>
